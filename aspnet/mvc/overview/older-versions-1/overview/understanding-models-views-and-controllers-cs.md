...
Denetleyici yalnızca bir sınıftır (örneğin, bir Visual Basic veya C# sınıfı). Örnek ASP.NET MVC uygulaması, denetleyiciler klasöründe bulunan HomeController.cs adlı bir denetleyici içerir. HomeController.cs dosyasının içeriği, liste 2 ' de yeniden oluşturulur.
