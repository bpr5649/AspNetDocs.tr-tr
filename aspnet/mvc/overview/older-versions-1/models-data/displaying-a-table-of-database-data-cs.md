...
[PDF’yi İndir](https://download.microsoft.com/download/1/1/f/11f721aa-d749-4ed7-bb89-a681b68894e6/ASPNET_MVC_Tutorial_11_CS.pdf)
...
**Şekil 01**: SQL sınıflarına LINQ oluşturma ([Tam boyutlu görüntüyü görüntülemek için tıklayınız](displaying-a-table-of-database-data-cs/_static/image2.png))
...
**Şekil 02**: Varlık Veri Modeli Tasarımcısı ([Tam boyutlu görüntüyü görüntülemek için tıklayınız](displaying-a-table-of-database-data-cs/_static/image4.png))
...
[![Denetleyici Ekle Menüsü](displaying-a-table-of-database-data-cs/_static/image3.jpg)](displaying-a-table-of-database-data-cs/_static/image5.png)

**Şekil 03**: Denetleyici Ekle Menüsü ([Tam boyutlu görüntüyü görüntülemek için tıklayınız](displaying-a-table-of-database-data-cs/_static/image6.png))
...
**Şekil 04**: Denetleyici Ekle iletişim kutusu([Tam boyutlu görüntüyü görüntülemek için tıklayınız](displaying-a-table-of-database-data-cs/_static/image8.png))
...
**Listeleme 1 – Denetleyiciler\MovieController.cs**

[!code-csharp[Main](displaying-a-table-of-database-data-cs/samples/sample1.cs)]

Listeleme 1'de, MoviesDBntities sınıfı MoviesDB veritabanını temsil etmek için kullanılır. Bu sınıfı kullanmak için, MvcApplication1.Models ad alanını şu şekilde içe aktarmanız gerekir:
...
**Şekil 07**: Bir film tablosu([Tam boyutlu görüntüyü görüntülemek için tıklayınız](displaying-a-table-of-database-data-cs/_static/image14.png))
...
Listeleme 4'teki görünüm, tüm filmlerde yineleyen bir foreach döngüsü içerir. Her film için, MovieTemplate kısmi film biçimlendirmek için kullanılır. MovieTemplate, RenderPartial() yardımcı yöntemini arayarak işlenir.
...
RenderPartial() yöntemi, bir dize döndürmediği için diğer yardımcı yöntemlerin çoğundan farklıdır. Bu nedenle, &lt;% Html.RenderPartial(); % yerine %=&gt; Html.RenderPartial(); &lt; %&gt;.
...
> [Sonraki](performing-simple-validation-cs.md)
