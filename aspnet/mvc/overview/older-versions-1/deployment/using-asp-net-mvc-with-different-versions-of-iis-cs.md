...
**Şekil 1**: İstek işleme modunu algılama ([Tam boyutlu görüntüyü görüntülemek için tıklayınız](using-asp-net-mvc-with-different-versions-of-iis-cs/_static/image2.png))
...
**Şekil 2**: 404 Bulunamadı hatası alma ([Tam boyutlu görüntüyü görüntülemek için tıklayınız](using-asp-net-mvc-with-different-versions-of-iis-cs/_static/image4.png))
...
**Şekil 3**: IIS 7.0 ile joker karakter komut dosyası haritası oluşturma ([Tam boyutlu görüntüyü görüntülemek için tıklayınız](using-asp-net-mvc-with-different-versions-of-iis-cs/_static/image6.png))
...
**Şekil 4**: IIS 6.0 ile joker karakter komut dosyası haritası oluşturma ([Tam boyutlu görüntüyü görüntülemek için tıklayın](using-asp-net-mvc-with-different-versions-of-iis-cs/_static/image8.png))
...
**Şekil 5**: Eksik Kök rota hatası([Tam boyutlu görüntüyü görüntülemek için tıklayınız](using-asp-net-mvc-with-different-versions-of-iis-cs/_static/image10.png))
