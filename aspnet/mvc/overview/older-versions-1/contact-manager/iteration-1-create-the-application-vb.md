...
---
# <a name="iteration-1--create-the-application-vb"></a>1. Yineleme – Uygulamayı oluşturma (VB)

[Microsoft](https://github.com/microsoft) tarafından

[İndirme Kodu](iteration-1-create-the-application-vb/_static/contactmanager_1_vb1.zip)
...
**Şekil 01**: Yeni Proje iletişim kutusu([Tam boyutlu görüntüyü görüntülemek için tıklayınız](iteration-1-create-the-application-vb/_static/image2.png))
...
**Şekil 02**: Birim Test Projesi Oluştur iletişim kutusu ([Tam boyutlu görüntüyü görüntülemek için tıklayınız](iteration-1-create-the-application-vb/_static/image4.png))
...
**Şekil 03**: Çözüm Gezgini penceresi ([Tam boyutlu görüntüyü görüntülemek için tıklayınız](iteration-1-create-the-application-vb/_static/image6.png))
...
- \Denetleyiciler\HomeController.vb
...
**Şekil 05**: Veritabanı Tablo Tasarımcısı ([Tam boyutlu görüntüyü görüntülemek için tıklayınız](iteration-1-create-the-application-vb/_static/image10.png))
...
**Şekil 07**: Model İçeriklerini Seçin ([Tam boyutlu görüntüyü görüntülemek için tıklayınız](iteration-1-create-the-application-vb/_static/image14.png))
...
**Şekil 09**: Veritabanı Nesnelerinizi Seçin ([Tam boyutlu görüntüyü görüntülemek için tıklayınız](iteration-1-create-the-application-vb/_static/image18.png))
...
**Şekil 10**: İletişim sınıfı ([Tam boyutlu görüntüyü görüntülemek için tıklayınız](iteration-1-create-the-application-vb/_static/image20.png))
...
**Şekil 11**: Ana Ekran denetleyicisinin eklenmesi ([Tam boyutlu görüntüyü görüntülemek için tıklayınız](iteration-1-create-the-application-vb/_static/image22.png))
...
**Şekil 12**: Dizin görünümünü ekleme ([Tam boyutlu görüntüyü görüntülemek için tıklayınız](iteration-1-create-the-application-vb/_static/image24.png))

Görünüm **Ekle** iletişim kutusunda, güçlü bir **şekilde yazılan görünüm oluşturma**etiketli onay kutusunu işaretleyin. Veri sınıfı ContactManager.Contact'ı ve Görünüm içerik Listesini seçin. Bu seçenekleri seçmek, Kişi kayıtlarının listesini görüntüleyen bir görünüm oluşturur.
...
**Şekil 15**: Dizin görünümü ([Tam boyutlu görüntüyü görüntülemek için tıklayınız](iteration-1-create-the-application-vb/_static/image30.png))
...
**Listeleme 4 - Denetleyiciler\HomeController.vb (Oluşturma yöntemleri ile)**
...
Görünüm **Ekle** iletişim **kutusunda, ContactManager.Contact** sınıfını ve görüntüleme içeriği için **Oluştur** seçeneğini seçin (Bkz. Şekil 17). **Ekle** düğmesini tıklattığınızda, oluştur görünümü otomatik olarak oluşturulur.
...
**Şekil 17**: Bir sayfanın patladığı nagöre ([Tam boyutlu görüntüyü görüntülemek için tıklayınız](iteration-1-create-the-application-vb/_static/image34.png))
...
**Şekil 18**: Görünüm Oluştur ([Tam boyutlu görüntüyü görüntülemek için tıklayınız](iteration-1-create-the-application-vb/_static/image36.png))
...
**Listeleme 6 - Denetleyiciler\HomeController.vb (Edit yöntemleri ile)**
...
**Şekil 19**: Edit Görünümü Ekleme ([Tam boyutlu görüntüyü görüntülemek için tıklayın](iteration-1-create-the-application-vb/_static/image38.png))
...
**Listeleme 8 - Denetleyiciler\HomeController.vb (Silme yöntemleri)**
...
**Şekil 20**: Silme onay görünümü ([Tam boyutlu görüntüyü görüntülemek için tıklayınız](iteration-1-create-the-application-vb/_static/image40.png))
...
**Şekil 21**: Edit bağlantısı ile dizin görünümü ([Tam boyutlu görüntüyü görüntülemek için tıklayınız](iteration-1-create-the-application-vb/_static/image42.png))
...
**Şekil 22**: Silme onay görünümünü ekleme ([Tam boyutlu görüntüyü görüntülemek için tıklayınız](iteration-1-create-the-application-vb/_static/image44.png))
...
Bu sorunu gidermek için yeterince kolaydır. İlk olarak, Ev denetleyicisinin adını yeniden düzenlememiz gerekiyor. Visual Studio Code Editor'da HomeController sınıfını açın, sınıfın adını sağ tıklatın ve menü seçeneğini yeniden **adlandır**Seçeneğini belirleyin. Bu menü seçeneğini seçmek, Yeniden Adlandır iletişim kutusunu açar.
...
**Şekil 23**: Denetleyici adını yeniden düzenleme ([Tam boyutlu görüntüyü görüntülemek için tıklayınız](iteration-1-create-the-application-vb/_static/image46.png))
...
**Şekil 24**: Yeniden Adlandırma iletişim kutusunu kullanma ([Tam boyutlu görüntüyü görüntülemek için tıklayın](iteration-1-create-the-application-vb/_static/image48.png))
...
**Şekil 25**: Varsayılan denetleyici yok ([Tam boyutlu görüntüyü görüntülemek için tıklayınız](iteration-1-create-the-application-vb/_static/image50.png))
