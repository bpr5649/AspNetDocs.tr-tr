...
---
# <a name="iteration-4--make-the-application-loosely-coupled-vb"></a>4. Yineleme – Uygulamanın gevşek bir şekilde bağlanmasını sağlama (VB)

[Microsoft](https://github.com/microsoft) tarafından

[İndirme Kodu](iteration-4-make-the-application-loosely-coupled-vb/_static/contactmanager_4_vb1.zip)
...
**Listeleme 1 - Modeller\IContactManagerRepository.vb**
...
**Listeleme 2 - Modeller\EntityContactManagerRepository.vb**
...
**Listeleme 4 - Modeller\ContactManagerService.vb**
...
**Listeleme 5 - Modeller\IContactManagerService.vb**
...
**Listeleme 6 - Denetleyiciler\ContactController.vb**
...
**Listeleme 7 - Modeller\Doğrulama\ModelStateWrapper.vb**

[!code-vb[Main](iteration-4-make-the-application-loosely-coupled-vb/samples/sample7.vb)]

**Listeleme 8 - Modeller\Doğrulama\IValidationDictionary.vb**
...
> [Sonraki](iteration-5-create-unit-tests-vb.md)
